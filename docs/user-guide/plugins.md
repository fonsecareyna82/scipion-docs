...
<img src="../../assets/images/screenshots/user-guide/plugins-page.png" alt="Plugins page" style="display:block;width:100%;max-width:980px;height:auto;margin:1.2rem auto 1.6rem;" />
